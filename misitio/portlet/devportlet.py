...
#from misitio.portlet import DevPortletMessageFactory as _


class IDevPortlet(IPortletDataProvider):
    """A portlet
...
class Renderer(base.Renderer):
    ...
    render = ViewPageTemplateFile('devportlet.pt')
...
class AddForm(base.AddForm):
    ...
    """
    form_fields = form.Fields(IDevPortlet)
